...
?>
    <div id="page-wrapper">
        <div class="col-sm-12 ">
            ...
            <div class="col-sm-2">
                    <a class="btn btn-success"  id="open-modal0" data-url="user_add_test.php" data-toggle="modal" data-target="#myModal">เพิ่มข้อมูล</a>
            </div>
            <div class="col-sm-4">
                            ...
                            ?>	
                                    <tr>
                                        <td class="text-center"><?=$n?></td>
                                            ...
                                            <td align="center">
                                                <div class="btn-group">
                                                    <a class="btn btn-default" id="open-modal1" data-toggle="modal" data-target="#myModal" data-url="user_add_test.php?id=<?=$array[user_id]?>&mode=edit" ><i class="fa fa-pencil"> แก้ไข</i></a>
        ...
        <div class=" modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">รายการบริการ</h4>
                </div>
