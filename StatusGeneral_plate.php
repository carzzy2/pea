...
?>
    <div id="page-wrapper">
            <center>
                <iframe src="StatusGeneral_print.php?id=<?=$_GET[id]?>" width="100%" height="600"></iframe>
            </center>
            <center>
                <div class="btn-group">
                    <a href="StatusGeneral.php" class="btn btn-info" >กลับหน้าแรก</a>
                    <a href="StatusGeneral_print.php?id=<?=$_GET[id]?>" class="btn btn-primary" target="_blank">พิมพ์</a>
                </div>
            </center>
