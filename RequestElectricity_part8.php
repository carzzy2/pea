...
$("#checkbox-place").click(function(){
    if ($(this).is(':checked')) {
    $("#re_keep_homeid").val("<?= $_SESSION[ss_cus_homeid] ?>");
    $("#re_keep_homeid").attr('readonly', true);
    $("#re_keep_number").val("<?= $_SESSION[ss_cus_number] ?>");
    $("#re_keep_number").attr('readonly', true);
    $("#re_keep_village").val("<?= $_SESSION[ss_cus_village] ?>");
    $("#re_keep_village").attr('readonly', true);
    $("#re_keep_room").val("<?= $_SESSION[ss_cus_room] ?>");
    $("#re_keep_room").attr('readonly', true);
    $("#re_keep_floor").val("<?= $_SESSION[ss_cus_floor] ?>");
    $("#re_keep_floor").attr('readonly', true);
    $("#re_keep_alley").val("<?= $_SESSION[ss_cus_alley] ?>");
    $("#re_keep_alley").attr('readonly', true);
    $("#re_keep_alleyway").val("<?= $_SESSION[ss_cus_alleyway] ?>");
    $("#re_keep_alleyway").attr('readonly', true);
    $("#re_keep_road").val("<?= $_SESSION[ss_cus_road] ?>");
    $("#re_keep_road").attr('readonly', true);
    $("#re_keep_vilno").val("<?= $_SESSION[ss_cus_vilno] ?>");
    $("#re_keep_vilno").attr('readonly', true);
    $("#re_keep_district").val("<?= $_SESSION[ss_cus_district] ?>");
    $("#re_keep_district").attr('readonly', true);
    $("#re_keep_canton").val("<?= $_SESSION[ss_cus_canton] ?>");
    $("#re_keep_canton").attr('readonly', true);
    $("#re_keep_province").val("<?= $_SESSION[ss_cus_province] ?>");
    $("#re_keep_province").attr('readonly', true);
    $("#re_keep_post").val("<?= $_SESSION[ss_cus_post] ?>");
    $("#re_keep_post").attr('readonly', true);
    $("#re_keep_tel").val("<?= $_SESSION[ss_cus_tel] ?>");
    $("#re_keep_tel").attr('readonly', true);
    $("#re_keep_fax").val("<?= $_SESSION[ss_cus_fax] ?>");
    $("#re_keep_fax").attr('readonly', true);
    $("#re_keep_road").val("<?= $_SESSION[ss_cus_road] ?>");
    $("#re_keep_road").attr('readonly', true);
    $("#re_keep_email").val("<?= $_SESSION[ss_cus_email] ?>");
    ...
    <div id="page-wrapper">
        <div class="panel panel-primary">
            ...
            <form method="post" action="RequestElectricity_save.php" enctype="multipart/form-data">
                <?php
