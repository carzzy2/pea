...
INSERT INTO `tb_customer` VALUES ('1218876659698', '1', 'สมยอม', 'ทันใด', '121887665', '1218876659698', '111', '12', 'กำหนัด', '-', '-', 'จุงใจ', 'ตามใจ', 'เต็มใจ', '2', 'น้อยใจ', 'จืดใจ', 'ขอนแก่น', '40000', '0868959653', '0868959653', 'somyom@gmail.com');
...
INSERT INTO `tb_electricity` VALUES ('120000000008', '2017-09-10', 'ท่าพระ', 'EMP00002', '1218876659698', 1, '-', 'บ้าน ใจใจ', '111', '12', 'กำหนัด', '-', '-', 'จุงใจ', 'ตามใจ', 'เต็มใจ', '', 'น้อยใจ', 'จืดใจ', 'ขอนแก่น', '40000', '0868959653', '0868959653', 'somyom@gmail.com', 'บ้านพัก', '-', '111', '12', 'กำหนัด', '-', '-', 'จุงใจ', 'ตามใจ', 'เต็มใจ', '2', 'น้อยใจ', 'จืดใจ', 'ขอนแก่น', '40000', '0868959653', '0868959653', 'somyom@gmail.com', 0, '-', '-', 0, '', '2017-09-10', 0, 'บ้าน', '111', '12', 'กำหนัด', '-', '-', 'จุงใจ', 'ตามใจ', 'เต็มใจ', '2', 'น้อยใจ', 'จืดใจ', 'ขอนแก่น', '40000', '0868959653', '0868959653', 'somyom@gmail.com', '../pea/img/ele/120000000008.jpg', 0);
...
INSERT INTO `tb_meter` VALUES ('ME00001', '15(45) แอมป์ 1 เฟส 2 สาย', 400.00, 0);
INSERT INTO `tb_meter` VALUES ('ME00002', '15(45) แอมป์ 1 เฟส 2 สาย', 4000.00, 0);
...
CREATE TABLE `tb_work_detail` (
  ...
  `work_detail` varchar(255) character set utf8 collate utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_work_detail` VALUES ('150000000001', 'EMP00003', 'วางระบบ,ติดตั้งสาย');
INSERT INTO `tb_work_detail` VALUES ('150000000001', 'EMP00004', 'คนขับรถ');
