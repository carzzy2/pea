...
INSERT INTO `tb_general` VALUES ('110000000007', '2017-07-10', 'มะลิวัลย์', 'EMP00002', '1102254587855', 0, '', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', 1, '-', '-', 0, 0);
INSERT INTO `tb_general` VALUES ('110000000008', '2017-10-10', 'ท่าพระ', 'EMP00002', '1102002129468', 0, '', '222', '001', '332', 'กระนวน', '-', '-', '-', '-', '-', '', 'กระนวน', 'ซำสูง', 'ขอนแก่น', '40170', '0921383707', '-', 'longpakdee@gmail.com', '', '', '001', '332', 'กระนวน', '-', '-', '-', '-', '-', '', 'กระนวน', 'ซำสูง', 'ขอนแก่น', '40170', '0921383707', '-', 'longpakdee@gmail.com', 8, '-', '-', 0, 0);
