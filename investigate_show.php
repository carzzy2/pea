...
?>
    <div id="page-wrapper">
        <div class="col-sm-12 ">
            ...
            <div class="col-sm-2">
                    <a href="investigate_add.php"  class="btn btn-success">เพิ่มข้อมูล</a>
            </div>
            <div class="col-sm-4">
            ...
            <div class="col-sm-12">
                <div class="table-responsive">
                    <?php
                        $sql_all_rows="select * from tb_investigate order by ig_id";
                    ...
                    for($i=1;$i<=$total_page;$i++){
                            if($start==$i){
                                    echo "<a href='investigate_show.php?start=".$i."&limit=".$limit."'><button class='btn btn-default '>".$i."</button></a>&nbsp;";
                            }else{
                                    echo "<a href='investigate_show.php?start=".$i."&limit=".$limit."' c><button class='btn btn-default active'>".$i."</button></a>&nbsp;";
                            }
                    ...
                    <table width="100%" class="table table-bordered table-hover">
                        <thead>               
                            ...
                            <?php
                                ...
                                $sql="select * from tb_investigate where ig_id like '%".$_POST[search]."%' order by ig_id desc limit $page,$limit";
