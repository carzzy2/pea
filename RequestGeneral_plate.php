    ...
    <div id="page-wrapper">
        <div class="panel panel-primary">
                <div class="panel-heading">
                    <h2 class="panel-title">คำร้องทั่วไปเลขที่<?=$_GET[rg_id]?></h2>
                </div>
            <div class="panel-body">
                <center>
                <iframe src="RequestGeneral_print.php?rg_id=<?=$_GET[rg_id]?>" width="100%" height="600"></iframe>
            </center>
            <center>
                <div class="btn-group">
                    <a href="RequestGeneral_show" class="btn btn-info" >กลับหน้าแรก</a>
                    <a href="RequestGeneral_print.php?rg_id=<?=$_GET[rg_id]?>" class="btn btn-primary" target="_blank">พิมพ์</a>
                </div>
            </center>
