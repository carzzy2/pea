            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a href="StatusGeneral.php"><i class="hidden-xs showopacity glyphicon glyphicon-ok-circle">&nbsp;</i>อนุมัติคำร้องทั่วไป</a></li>
                        ...
                        <li><a href="#.php"><i class="hidden-xs showopacity glyphicon glyphicon-usd">&nbsp;</i>รับชำระค่าธรรมเนียม</a></li>
