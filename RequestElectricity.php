                    ...
                    <div class="panel-body">
                        <div class="row">
                            <form name="frmSearch" method="POST" >
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group input-group">
                                        <a href="RequestElectricity_part1.php"><input type="button" value="เพื่มผู้ใช้บริการใหม่" class="btn  btn-info"></a>
                                    </div>
                                </div>
                            </form>
                        </div>
                                        ...
                                        if (mysql_num_rows($result) < 1) {
                                            ...
                                            while ($array = mysql_fetch_array($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <a class="btn btn-default" href="RequestElectricity_Ses.php?id=<?= $array[cus_id] ?>&mode=RequestElectricity_part1" title="เลือก"><i class="fa fa-check-circle-o"> เลือก</i></a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
                        ...
                        <a class="btn btn-danger" onclick="location.href = 'RequestElectricity_show.php'"> ยกเลิก</a>
                    </div>				
                </div>
            </div>
        </div>
